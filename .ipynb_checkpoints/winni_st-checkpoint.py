...
if selected == 'Add Fish':
    ...
    def main():
        ...
        with st.form(key='myform', clear_on_submit=True):
            ...
            record = [day, day,location_selector, fish_type, fish_length, water_depth, time_caught, weather_condition, temperature, water_temperature, wind_dir_selector, wind_speed,0 ,0 ,0 ,0,0 ,0 ,0 ,0]
